...
void main() {
  ...
  late GetMaterialsByDescriptionImpl usecase;

  setUp(() {
    mockMaterialCatalogRepository = MockMaterialCatalogRepository();
    usecase = GetMaterialsByDescriptionImpl(mockMaterialCatalogRepository);
  });
  ...
  test(
    ...
    () async {
      // arrange
      when(
        () => mockMaterialCatalogRepository.getMaterialsByDescription(tQuery),
