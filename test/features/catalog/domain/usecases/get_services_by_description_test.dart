...
void main() {
  ...
  late GetServicesByDescriptionImpl usecase;

  setUp(() {
    mockServiceCatalogRepository = MockServiceCatalogRepository();
    usecase = GetServicesByDescriptionImpl(mockServiceCatalogRepository);
  });
  ...
  test(
    ...
    () async {
      // arrange
      when(
        () => mockServiceCatalogRepository.getServicesByDescription(tQuery),
